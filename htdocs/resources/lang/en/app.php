...
return [
  ...
  // Horizontal content blocks
    "home_horizontal_blocks_responsiveness" => [
    "xs" => "12",
    "sm" => "4",
    "md" => "4",
    "lg" => "4",
  ...
  "home_horizontal_blocks_aspect_ratio" => "1.7",
  "home_horizontal_blocks_img_classes" => "elevation-3",
  "home_horizontal_blocks_title_classes" => "headline mt-5",
  ...
  "home_vertical_blocks_aspect_ratio" => "1.7",
  "home_vertical_blocks_img_classes" => "elevation-3",
  "home_vertical_blocks_title_classes" => "display-2 my-10",
  ...
  // Horizontal content blocks
    "about_horizontal_blocks_responsiveness" => [
    "xs" => "12",
    "sm" => "4",
    "md" => "4",
    "lg" => "4",
  ...
  "about_horizontal_blocks_aspect_ratio" => "1.7",
  "about_horizontal_blocks_img_classes" => "elevation-3",
  "about_horizontal_blocks_title_classes" => "headline mt-5",
  ...
  // Vertical content blocks
  "about_vertical_blocks_aspect_ratio" => "1.7",
  "about_vertical_blocks_img_classes" => "elevation-3",
  "about_vertical_blocks_title_classes" => "display-2 my-10",
  ...
  "contact" => "Contact",
  "contact_paragraphs" => [
    "Please send an email to :app_contact_email.",
  ...
  "_required_" => " (required)",
  "_optional_" => " (optional)",
  "confirm_delete" => "Do you want to delete the selected record(s)? This cannot be undone. Linked items may also be deleted.",
  "delete_selected" => "Delete selected",
  "items_deleted" => "{items} items deleted",
  ...
  "experience_empty_list" => "Add education and work experience here.",
  "education" => "Education",
  "work" => "Work",
